...
IASControl_comment = {
    ...
    "triggers": [
        ...
        "Во вкладке «Общая информация» необходимо заполнить данные полю «Дополнительные календари/разделы»",
        ],
    "verify_status": [
...
def input_report_text(df, excel_file_path, report_text=''):
    ...
    if df.empty:
        ...
        df_excel.to_excel(excel_file_path, index=False, engine="xlsxwriter")
        return
