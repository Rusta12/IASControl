...
IASControl_comment = {
    ...
    "verify_status": [
        "Не коретный статус, пожалуйста уточните категорию мероприятия или наименование (либо уберите слово Первенство из навзания)",
        "Для внесения международных мероприятий в Москве необходимо выбрать сооотвествующий подраздел (Международные соревнования)",
        ],
    "sports": [
        "Пожалуйста не используйте в виде спорта - комплексное мероприятие, если хотите использовать несколько видов спорта используйте чек-бокс мултиспортивные",
        "",
        ],
}
